...
/// FinEdu design tokens: extracted 1:1 from design_reference CSS `:root`.
class C {
  // Surfaces / background
...
class Sh {
  static List<BoxShadow> card = const [
    BoxShadow(color: Color.fromRGBO(26, 64, 130, 0.34), offset: Offset(0, 22), blurRadius: 42, spreadRadius: -20),
    BoxShadow(color: Color.fromRGBO(255, 255, 255, 0.95), offset: Offset(0, 3), blurRadius: 3, inset: true),
    BoxShadow(color: Color.fromRGBO(70, 110, 180, 0.13), offset: Offset(0, -16), blurRadius: 22, spreadRadius: -12, inset: true),
  ];

  static List<BoxShadow> raise = const [
    BoxShadow(color: Color.fromRGBO(26, 64, 130, 0.26), offset: Offset(0, 12), blurRadius: 22, spreadRadius: -12),
    BoxShadow(color: Color.fromRGBO(255, 255, 255, 0.95), offset: Offset(0, 2), blurRadius: 2, inset: true),
    BoxShadow(color: Color.fromRGBO(70, 110, 180, 0.15), offset: Offset(0, -8), blurRadius: 12, spreadRadius: -8, inset: true),
  ];

  static List<BoxShadow> insetSoft = const [
    BoxShadow(color: Color.fromRGBO(50, 90, 160, 0.20), offset: Offset(0, 3), blurRadius: 7, inset: true),
    BoxShadow(color: Color.fromRGBO(255, 255, 255, 0.85), offset: Offset(0, -1.5), blurRadius: 1, inset: true),
  ];

  static List<BoxShadow> nav = const [
    BoxShadow(color: Color.fromRGBO(26, 64, 130, 0.40), offset: Offset(0, 20), blurRadius: 44, spreadRadius: -16),
    BoxShadow(color: Color.fromRGBO(255, 255, 255, 0.95), offset: Offset(0, 2), blurRadius: 2, inset: true),
  ];

  static List<BoxShadow> blue = const [
    BoxShadow(color: Color.fromRGBO(21, 96, 216, 0.50), offset: Offset(0, 14), blurRadius: 24, spreadRadius: -8),
    BoxShadow(color: Color.fromRGBO(255, 255, 255, 0.55), offset: Offset(0, 3), blurRadius: 3, inset: true),
    BoxShadow(color: Color.fromRGBO(16, 70, 170, 0.50), offset: Offset(0, -9), blurRadius: 13, spreadRadius: -5, inset: true),
  ];

  static List<BoxShadow> amber = const [
    BoxShadow(color: Color.fromRGBO(224, 138, 0, 0.45), offset: Offset(0, 14), blurRadius: 24, spreadRadius: -8),
    BoxShadow(color: Color.fromRGBO(255, 255, 255, 0.62), offset: Offset(0, 3), blurRadius: 3, inset: true),
    BoxShadow(color: Color.fromRGBO(170, 105, 0, 0.42), offset: Offset(0, -9), blurRadius: 13, spreadRadius: -5, inset: true),
  ];

  static List<BoxShadow> danger = const [
    BoxShadow(color: Color.fromRGBO(214, 52, 80, 0.40), offset: Offset(0, 14), blurRadius: 24, spreadRadius: -8),
    BoxShadow(color: Color.fromRGBO(255, 255, 255, 0.50), offset: Offset(0, 3), blurRadius: 3, inset: true),
    BoxShadow(color: Color.fromRGBO(160, 35, 55, 0.40), offset: Offset(0, -9), blurRadius: 13, spreadRadius: -5, inset: true),
  ];

  static List<BoxShadow> violet = const [
    BoxShadow(color: Color.fromRGBO(93, 69, 224, 0.40), offset: Offset(0, 14), blurRadius: 24, spreadRadius: -8),
    BoxShadow(color: Color.fromRGBO(255, 255, 255, 0.50), offset: Offset(0, 3), blurRadius: 3, inset: true),
    BoxShadow(color: Color.fromRGBO(70, 45, 170, 0.42), offset: Offset(0, -9), blurRadius: 13, spreadRadius: -5, inset: true),
  ];

  static List<BoxShadow> green = const [
    BoxShadow(color: Color.fromRGBO(18, 147, 74, 0.42), offset: Offset(0, 14), blurRadius: 24, spreadRadius: -8),
    BoxShadow(color: Color.fromRGBO(255, 255, 255, 0.55), offset: Offset(0, 3), blurRadius: 3, inset: true),
    BoxShadow(color: Color.fromRGBO(10, 110, 55, 0.42), offset: Offset(0, -9), blurRadius: 13, spreadRadius: -5, inset: true),
  ];
}

/// Colored button gradients. CSS: linear-gradient(180deg, mix(color 88%,#fff), color 52%, deep)
class Grad {
  ...
  // Score pill: linear-gradient(180deg,#63a4ff,#2B86FF 60%,#1560D8)
  ...
  // Center nav FAB: linear-gradient(180deg,#7fb4ff,#2B86FF 55%,#1560D8)
  ...
  // Ring gradient blue -> sky (topLeft -> bottomRight)
  static const LinearGradient ring = LinearGradient(
    begin: Alignment.topLeft,
    end: Alignment.bottomRight,
    colors: [C.blue, C.sky],
  );
  // Score ring gradient sky -> blue
...
/// Mascot asset paths (Cashy states).
class Cashy {
  ...
  static const cashyCelebrate = '${base}squirrel_celebration.png'; // Reward
  static const cashyPoint = '${base}squirrel_neutral.png'; // Ghid (pointing)
