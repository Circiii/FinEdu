...
void main() {
  ...
  group('RichLessonText', () {
    testWidgets('**bold** și ==evidențiat== devin span-uri stilate',
        (tester) async {
      await tester.pumpWidget(_app(RichLessonText(
        'A **b** și ==c== d',
      ...
      expect(spans[3].style!.background, isNotNull,
  ...
  group('LessonBlocksPage', () {
    testWidgets('dezvăluie blocurile pe rând și anunță finalul o dată',
        (tester) async {
      var revealed = 0;
      await tester.pumpWidget(_app(LessonBlocksPage(
        blocks: const [
      ...
      expect(find.text('CHECK-UL'), findsOneWidget,
  ...
  group('order', () {
    ...
    testWidgets('ordinea corectă din prima → onResult true', (tester) async {
      ...
      expect(find.text('Fix așa.'), findsOneWidget,
